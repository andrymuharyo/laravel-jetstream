    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-4 sm:items-top sm:justify-between grid sm:grid-cols-12 gap-10">  
            <div class="col-span-6">
                ...
                @csrf 
                    <div class="mb-4">
                        <x-jet-label for="firstname" value="{{ __('label.firstname.name') }}" wire:model.defer="firstname" />
                        <x-jet-input id="firstname" type="text" class="mt-1 block w-full" wire:model.defer="firstname" name="firstname" placeholder="{{ __('label.firstname.placeholder') }}" />
                        <x-jet-input-error for="firstname" class="mt-2" />
                    </div>
                    <div class="mb-4">
                        <x-jet-label for="lastname" value="{{ __('label.lastname.name') }}" wire:model.defer="lastname" />
                        <x-jet-input id="lastname" type="text" class="mt-1 block w-full" wire:model.defer="lastname" name="lastname" placeholder="{{ __('label.lastname.placeholder') }}" />
