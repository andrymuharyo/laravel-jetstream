                ...
                @if(count($legals) > 0)
                    <table class="table-fixed w-full border-2 border-gray-200 sm:border-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border-b-2 border-gray-100 px-4 py-2 hidden sm:table-cell">{{ $legal->no }}</td>
                                <td class="border-b-2 border-gray-100 px-4 py-2">{{ $legal->title }}</td>
                                ...
                                <td class="border-b-2 border-gray-100 px-4 py-2 hidden sm:table-cell">{{ ($legal->submitted_at) ? $legal->submitted_at->toFormattedDateString() : null }}</td>
                                <td class="border-b-2 border-gray-100 px-4 py-2 hidden sm:table-cell">
                                    {{ ($legal->created_at) ? $legal->created_at->toFormattedDateString() : null }}
                                    <br/>
                                    {{ ($legal->updated_at) ? $legal->updated_at->toFormattedDateString() : null }}
                                </td>
                                <td class="border-b-2 border-gray-100 px-4 py-2 text-center">
                                    @include('components.backend.action',array('id' => $legal->id))
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
