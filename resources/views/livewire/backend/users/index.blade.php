                    ...
                    <table class="table-fixed w-full border-2 border-gray-200 sm:border-0">
                        <thead>
                            <tr class="bg-gray-50 text-left">
                                ...
                                <th class="border-b-2 border-gray-200 px-4 py-2 hidden sm:table-cell" width="10%">{{ __('label.photo.name') }}</th>
                                <th class="border-b-2 border-gray-200 px-4 py-2">{{ __('label.username.name') }}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border-b-2 border-gray-100 px-4 py-2 hidden sm:table-cell">{{ $user->no }}</td>
                                ...
                                @endif
                                <td class="border-b-2 border-gray-100 px-4 py-2">{{ $user->username }}</td>
                                <td class="border-b-2 border-gray-100 px-4 py-2">{{ $user->name }}</td>
                                ...
                                <td class="border-b-2 border-gray-100 px-4 py-2 hidden sm:table-cell">
                                    {{ ($user->created_at) ? $user->created_at->toFormattedDateString() : null }}
                                    <br/>
                                    {{ ($user->updated_at) ? $user->updated_at->toFormattedDateString() : null }}
                                </td>
                                <td class="border-b-2 border-gray-100 px-4 py-2 text-center">
                                    @include('components.backend.action-user',array('id' => $user->id))
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
