                ...
                <div class="bg-white px-4 sm:pt-3 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid sm:grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-4">
                            ...
                            <div class="mb-4">
                                <x-jet-label for="privacy" value="{{ __('label.privacy.name') }}" wire:model="privacy" />
                                <x:backend.dropdown :withSearch="false" wire:model.defer="privacy" name="privacy" :options="$listPrivacy" wire:selected="{{ $this->privacy }}"  wire:change="setPrivacy($event.target.value)">
                                    <option value="">{{ __('label.privacy.placeholder') }}</option>
                                </x:backend.dropdown>
