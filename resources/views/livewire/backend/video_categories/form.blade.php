                    ...
                    <div class="grid sm:grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-4">
                            <div class="mb-4">
                                ...
                                <x-backend.datepicker wire:model.defer="submitted_at" :id="'submitted-at-'.$this->videoCategoryId" name="submitted_at" value="{{ $this->submitted_at }}" ></x-backend-datepicker>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 grid sm:grid-flow-col gap-4 text-left">
                    ...
                    <div class="mt-1">
                        <span class="inline w-full sm:mt-0 sm:w-auto">
                            <x-backend.toggle wire:model.defer="active" :id="'active-'.$this->videoCategoryId" name="active" value="active" label="{{ __('label.active.name') }}" />
                        </span>
                    </div>
