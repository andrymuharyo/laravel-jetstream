<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
    <form enctype="multipart/form-data" wire:submit.prevent="store()">
        @csrf
        <div class="shadow overflow-hidden sm:rounded-md mb-10">
            <div class="bg-white">      
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid sm:grid-flow-col gap-4">
                        <div class="col-span-12 sm:col-span-4">
                            <div class="mb-4">
                                ...
                                <x-backend.datepicker wire:model.defer="submitted_at" :id="'submitted-at-'.$this->photoId" name="submitted_at" value="{{ $this->submitted_at }}" ></x-backend-datepicker>
                                <x-jet-input-error for="submitted_at" class="mt-2" />
                            </div>
                            <div class="mb-4">
                                <x-backend.image wire:model.defer="image" :id="'image-'.$this->photoId" 
                                    module="{{ $this->module }}" 
                                    name="image" 
                                    value="{{ $this->image }}" 
                    ...
                    @include('livewire.backend.'.mb_strtolower($pageName).'.item')
                </div>
            </div>
        </div>
            ...
            <div class="bg-indigo-100 px-4 py-3 sm:px-6 grid sm:grid-flow-col gap-4 text-left">
                ...
                <div class="mt-1">
                    <span class="inline w-full sm:mt-0 sm:w-auto">
                        <x-backend.toggle wire:model.defer="active" :id="'active-'.$this->photoId" name="active" value="active" label="{{ __('label.active.name') }}" />
                    </span>
                </div>
