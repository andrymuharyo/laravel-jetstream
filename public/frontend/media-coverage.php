                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <ul>
                                            <li><a href="#"><i class="fas fa-angle-right"></i> Kumparan (Online Media) - January 2021</a></li>
                                            <li><a href="#"><i class="fas fa-angle-right"></i> Kompas (Newspaper) - January 2021</a></li>
                                            <li><a href="#"><i class="fas fa-angle-right"></i> Tempo (Magazine) - January 2021</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
