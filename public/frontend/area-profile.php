            ...
            <div class="row">
                <div class="col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">About AIHSP</a></li>
                        <li class="breadcrumb-item active" aria-current="page">AIHSP Strategic Direction</li>
                    </ol>
                </div>
            </div>
        </div>
	...
	<div class="container">
		<div class="landing-overview base-padding">
			<div class="row">
				<div class="col-md-8">
					<div class="content">
						<h1 class="title">AREA Profile</h1>
                        <div class="map-container">
                            <div class="map">
                                <img src="images/maps.png" usemap="#Map" />
                                ...
                                <a href="#">
                                    <button style="top: 82.155%; left: 39.955%;" class="icon-fix">
                                        <i class="fas fa-map-pin"></i>
                                        <div class="tool-tip hidden-sm hidden-md hidden-lg">Bali</div>
                                    </button>
                                    <div class="pop-up hidden-xs">
                                        <h6><strong>Bali</strong></h6>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In porttitor diam at eros vehicula, id accumsan massa vestibulum. Proin blandit sed elit ut semper.</p>
                                    </div>
                                </a>
                            </div>
                        </div>
				...
				<div class="col-md-4">
					<div class="side-nav">
						<h4>About AIHSP</h4>
                        <ul>
                            <li><a class="active" href="aihsp-strategic-direction.php">AIHSP Strategic Direction</a></li>
                            <li><a href="what-we-do.php">What We Do</a></li>
                            <li><a href="how-we-work.php">How We Work</a></li>
                            <li><a href="governance-structure.php">Governance Structure</a></li>
                            <li><a href="who-we-are.php">Who We Are</a></li>
                            <li><a href="area-profile.php">AREA Profile</a></li>
